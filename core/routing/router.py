...
class LLMRouter:
    ...
    def __init__(self, default_policy: RoutingPolicy | None = None):
    ...
    def _task_to_capability(self, task_type: TaskType) -> ModelCapability | None:
    ...
    def _calculate_capability_score(
        self, model: Any, task_type: TaskType | None
    ) -> float:
