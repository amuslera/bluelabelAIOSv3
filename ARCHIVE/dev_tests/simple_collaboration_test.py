...
async def simulate_real_collaboration():
    ...
    await backend.send_message("I'll handle tasks 2 and 3. I'll start with the login endpoint once the architecture is ready.")
    ...
    print("Collaboration time: ~5 minutes")
    print("Team satisfaction: High ⭐⭐⭐⭐⭐")
