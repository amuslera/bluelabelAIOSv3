...
class CollaborationClient:
    ...
    def show_help(self):
        ...
        print("   status <status>   - Update your status (active/busy/idle)")
        print("   task <title>      - Create new task")
        ...
        if self.role == "human":
            ...
            print("   - Define requirements and priorities")
            print("   - Ask questions about implementation")
            print("   - Approve/reject technical decisions")

        elif self.role == "cto":
            print("\n🎯 As CTO, you can:")
            print("   - Provide technical architecture guidance")
            print("   - Make technology decisions")
            print("   - Review and approve designs")

        elif self.role == "backend-dev":
            print("\n🎯 As Backend Developer, you can:")
            print("   - Implement features and APIs")
            print("   - Write tests and documentation")
