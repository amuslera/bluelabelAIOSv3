...
from agents.specialists.cto_agent import CTOAgent, create_cto_agent
from core.routing.providers.claude import ClaudeConfig, ClaudeProvider
from core.routing.providers.mock_provider import MockConfig, MockProvider
...
class LiveCollaborationDemo:
    ...
    async def show_session_summary(self):
        ...
        print("🎯 Collaboration scenarios: 3")
